  ...
  menuItems = [
    ...
    },
    {
      ...
      active: false
        ...
        {
      label: 'Mes reunions',
      link: 'Etudiant/Reunion/RommsList',
  ...
  stats = [
    {
      ...
      subtext: '75% complété en moyenne',
      animationDelay: ''
    },
    {
  ...
  enrolledCourses = [
    {
      ...
      description: 'Maîtrisez Python pour le développement web et l\'IA',
      hours: '10/30h',
      progress: 70,
    ...
    },
    {
      ...
      description: 'Apprenez Adobe Photoshop et Illustrator',
      hours: '3/15h',
      progress: 25,
  ...
  recentActivities = [
    {
      ...
      description: `<span class="font-semibold">Vous</span> avez terminé le chapitre "Fonctions Python" dans <span class="text-blue-400">Programmation Python Avancée</span>`,
      time: 'Il y a 1 heure',
    ...
    {
      iconBg: 'bg-green-500 bg-opacity-20',
      icon: 'fas fa-certificate text-green-400',
      description: `<span class="font-semibold">Vous</span> avez obtenu le certificat "Introduction à Python" avec une note de <span class="text-green-400">95%</span>`,
      time: 'Hier à 15:30',
      dotColor: '',
      animationDelay: 'animate__delay-1s'
    },
    {
      ...
      description: `<span class="font-semibold">Prof. Martin</span> a répondu à votre question dans <span class="text-purple-400">Introduction à l\'IA</span>`,
      time: 'Hier à 11:00',
    ...
    {
      iconBg: 'bg-yellow-500 bg-opacity-20',
      icon: 'fas fa-medal text-yellow-400',
      description: `<span class="font-semibold">Félicitations !</span> Vous avez débloqué le badge "5 jours d\'apprentissage"`,
      time: 'Avant-hier à 09:15',
      dotColor: '',
      animationDelay: 'animate__delay-3s'
    }
  ];
...
ngOnInit(): void {
  ...
  if (user) {
    ...
    this.student.photo = ''; // image par défaut
  }
}
